...
import { Plus, Edit, Trash2, Package, ArrowLeft, Eye, EyeOff, Search } from 'lucide-react';
...
export default function ProductList() {
  ...
  if (!currentStoreId) {
    return <div className="p-6 text-center">Selecione uma loja para ver os produtos</div>;
  }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Gerencie o cardápio da sua loja</p>
              </div>
            </div>
